...
var (
	...
	partitionTimeStart    string
	partitionTimeEnd      string
	partitionTimeInterval string
)
...
func init() {
	...
	pflag.String("partition-timestamp-start", defaultTimeStart, "Partition by time range start")
	pflag.String("partition-timestamp-end", defaultTimeEnd, "Partition by time range end")
	pflag.String("partition-timestamp-interval", defaultTimeInterval, "Duration between Partition time range")
	...
	partitionTimeStart = viper.GetString("partition-timestamp-start")
	partitionTimeEnd = viper.GetString("partition-timestamp-end")
	partitionTimeInterval = viper.GetString("partition-timestamp-interval")
